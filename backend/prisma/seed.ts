...
] = await hashAll(['admin123', 'manager123', 'worker123', 'agent123']);
...
// Tarek Boudissa (t.boudissa) — 5 ABSENCE_AUTHs
...
// Wissem Taleb (w.taleb) — 4 MISSION_ORDERs, long, by plane
...
// Yasmine Hadj (y.hadj) — 4 requests stuck in PENDING for days
...
// Nadia Cherif & Lynda Aissaoui & Imane Zitouni — normal employees
